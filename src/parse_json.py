...
def load_json(file_path):
    ...
    try:
        ...
        print(f"Error: The file '{file_path}' contains valid JSON.")
        return None
    ...
    for student in students:
        ...
        for course in courses:
            print(
                ...
                f"({course['units']} units) | Instruction: {course['instructor']}"
            )
...
def main():
    ...
    """
    json_file_path = Path(__file__).parent.parent / "data" / "students.json"
